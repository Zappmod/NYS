...
```
Please push this to my git repo located here: https://github.com/Zappmod/NYS.git — push all files to the main branch, then tell me any manual steps I need to take to make the site live on GitHub Pages.
```
